...
const defaultSettings: DuoSettings = {
  ...
  autoDualScreen: true,
  autoRotate: false,
  keyboardBacklightPowerSave: false,
  autoQuietOnBattery: false,
  activePerformanceMode: "balanced",
  performanceProfiles: {
    quiet: { pl1Watts: 12, pl2Watts: 15, pl3Watts: 20 },
    balanced: { pl1Watts: 35, pl2Watts: 45, pl3Watts: 50 },
    performance: { pl1Watts: 45, pl2Watts: 55, pl3Watts: 65 },
  },
  syncBrightness: true,
  theme: "system",
