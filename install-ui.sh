...
Usage:
  ./install-ui.sh [--repo URL] [--branch BRANCH] [--dir PATH] [--keep-dir] [--no-autostart]
...
Notes:
  ...
  - By default, it is also added to your desktop session autostart.
EOF
}
...
ensure_autostart_entry() {
  ...
  local autostart_file="${autostart_dir}/zenbook-duo-control.desktop"
